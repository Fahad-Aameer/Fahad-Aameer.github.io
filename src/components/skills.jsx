...
export function Skills() {
    ...
    return (
        <div className="mb-10 mx-10 md:mx-20 lg:mx-20 my-14 md:my-28 lg:my-28">
            <h2 className="text-2xl md:text-4xl lg:text-4xl text-center md:text-left lg:text-left font-extrabold text-gray-50 font-secondary-font mb-8">My skill highlights.</h2>
