export function Footer() {
    return(
        <div className="px-10 py-20 md:px-60 md:py-40 lg:px-60 lg:py-40 md:flex lg:flex justify-between">
            <p className="mb-10 md:mb-0 lg:mb-0 text-xs md:text-base lg:text-base font-thin text-gray-400 tracking-widest">© 2023 Fahad Aameer <strong className="text-gray-50/10">•</strong> Made with React</p>
            <div className="flex md:justify-between lg:justify-between space-x-16 md:space-x-40 lg:space-x-40">
